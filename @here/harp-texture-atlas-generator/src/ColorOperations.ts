 ...
 * (R + G + B) / 3.
 * This method may not produce natural pictures since all three different colors have different
 * wavelength thus in rallity their contribution to the image formation is different, in
 * average approach their contribution is assumed to be the same.
 * @param src source color.
 * @return grayscale converted color.
 */
 ...
 * It also averages the color components values, but it uses a weighted average to take into
 * account for human perception. Because human eye is more sensitive to green than other colors,
 * green compound is weighted most heavily. The weighter formula for luminosity is:
